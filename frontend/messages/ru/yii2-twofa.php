<?php
return [
    'Or you can also enter the secret manually:' => 'Или вы так же можете ввести код вручную:',
    'Two-Factor authentication is already enabled.' => 'Двух-факторная аутентификация уже включена.',
