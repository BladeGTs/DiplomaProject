    ...
    <div class="navbar-wrapper">
        <div class="navbar-logo">
            ...
            <a href="<?= Yii::$app->homeUrl ?>">
                <img class="img-fluid" style="max-width: 190px; padding-top: 17px;" src="/img/logo.png"
                     alt="Theme-Logo">
...
<div class="main-menu" id="menu-static">
    <div class="main-menu-header">
        <img src="<?php if (Yii::$app->user->identity) {
            echo Yii::$app->user->identity->getPicture();
        } ?>" id="profile-picture-left" class="img-fluid rounded-circle" style="max-width: 40px;"/>
        ...
        <ul class="main-navigation">
            <li class="more-details" style="display: none;">
                <a href="<?php if (Yii::$app->user->identity) {
                    echo Url::to(['/user/profile/view', 'nickname' => Yii::$app->user->identity->nickname]);
                } ?>"><i class="ti-user"></i>Профиль</a>
